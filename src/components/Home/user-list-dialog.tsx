...
// import { users } from "@/dummy-data/db"; //now we no longer need this dummy dabase of users
  ...
  const handleCreateConversation = async () => {
    ...
    try {
      ...
      if (!isGroup) {
        ...
        // group chat
        // will provie us short lived url
        // read the convex documentation for it.
